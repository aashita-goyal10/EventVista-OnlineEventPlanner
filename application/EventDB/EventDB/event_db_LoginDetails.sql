...
INSERT INTO `LoginDetails` VALUES ('email1@example.com','password1','User1'),('email2@example.com','password2','User2'),('email3@example.com','password3','User3'),('email4@example.com','password4','User4'),('email5@example.com','password5','User5');
